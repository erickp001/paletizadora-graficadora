...
namespace PaletizadoraV1
{
    public static class TemaColores
    {
        ...
        //Colores Defecto
        private static readonly Color PanelPadreD = Color.FromArgb(59, 35, 112);
        private static readonly Color PanelBotonesD = Color.FromArgb(51, 51, 76);
        private static readonly Color BarraTituloD = Color.FromArgb(39, 39, 58);
        ...
        //Tema Celeste
        private static readonly Color PanelPadreC = Color.FromArgb(65, 103, 135);
        private static readonly Color PanelBotonesC = Color.FromArgb(244, 244, 244);
        private static readonly Color BarraTituloC = Color.FromArgb(233, 233, 236);
        ...
        //tema Blue
        private static readonly Color PanelPadreB = Color.FromArgb(31, 30, 68);
